...
window.renderApp = (function () {
  ...
  var renderAdder = function (onSubmitAdder) {
    // TODO initialize form variable to '<form class="adder"/>'
    // TODO add event listener to form for 'submit' event: onSubmitAdder

    // TODO initialize input variable to '<input type="text" placeholder="text of new item"/>'

    // TODO initialize button variable to '<button type="submit">Add item</button>'
